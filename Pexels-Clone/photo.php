...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="..........js/magiczoomplus.css"/>
                    ...
                    <span class="pd">
                        ...
                        <span>
                            <span class="p-2" style="font-weight: bold;font-size: 15px;display: inline-block;">
                                ...
                                <br>
                                <span style="font-weight:100;font-size: 13px;"><b class="F"><?php echo $f;?></b> followers.</span>
                            </span>
                        </span>
                        <?php if((isset($_SESSION['sessUser']) && $id != $_SESSION['sessUser']) || !isset($_SESSION['sessUser']))
    echo  '
                ...
                <span class="bt1 btn-group p-2 d-inline-block align-top text-center" role="group" aria-label="Basic example">
                    ...
                    <div class="btn-group bt4" style="vertical-align: baseline;">
                        ...
                        <button type="button" class="bt4 rounded-start button_coloured dropdown-toggle-split rd__button--compact rounded rounded-0"> 
                            <i class="fa fa-download" style="font-size:24px;visibility:hidden;"></i>
                            <a id="imageLink" data-id="<?php echo $k;?>" style="color:white;text-decoration: none;" href="https://localhost/img/img.php?pname=<?php echo $name;?>" download target="_blank" >
                            Free Download
                            </a>
                        </button><button type="button" class="button_coloured dropdown-toggle dropdown-toggle-split rounded-end p-2" style="border-left: 1px solid lightgray;" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="min-width: 250px;">
                            ...
                            <ul class="list-group rounded-0">
                                ...
                                <li class="list-group-item p-3 border-start-0 border-end-0  ">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" id="cusT" disabled="" data-type="custom" class="form-check-input" name="optradio">Custom
                                        </label>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col">
                                            <input type="text" id="customWidth"  class="form-control" placeholder="Width">
                                        </div>
                                        <div class="col">
                                            <input type="text" id="customHeight" class="form-control" placeholder="Height">
                                        </div>
                                    </div>
                                </li>
                                <li class="list-group-item border-0 ">
                                    <a id="downIT" data-id="<?php echo $k;?>" href="" download="Image.jpg" class="button_coloured w-100 rd__button--compact"> Free Download </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row align-items-center" style="min-height: 50vh;">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-10 text-center m-auto">
                        <div class="photoItem profilePhotoItem py-2 position-relative text-white">
                            <a href="https://localhost/img/img.php?pname=<?php echo $name;?>" class="MagicZoom" data-options="zoomPosition: inner">
                            <img class="imgCrousel"  src="https://localhost/img/img.php?pname=<?php echo $name;?>" /></a>
                    ...
                    <div class="card w100-768 p-3 m-2 d-inline-block" style="min-width: 320px;border: 1px solid lightgray!important;">
                        ...
                        <span class="navbar-brand ">
                            ...
                            <span class="btn-group p-2  text-start" role="group" aria-label="Basic example">
                                ...
                                <button data-user="<?php echo $id;?>" data-command="<?php echo $c;?>" class="followButton btn btn-sm m-2 button_coloured rd__button--compact rd__button--white">Follow</button>                            </span>
                    ...
                    <div class="card p-3 m-2 w100-768 d-inline-block" style="min-width: 280px;border: 1px solid lightgray!important;">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr class="d-none">
                                    <td>Color</td>
                                    <td><div class="d-inline-block" style="height:20px;width:20px;background:brown;border-radius:50%;"></div>
                                        <div class="d-inline-block" style="height:20px;width:20px;background:pink;border-radius:50%;"></div></td>
                                </tr>        
                            </tbody>
                        </table>
                    </div> 
