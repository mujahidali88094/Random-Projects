            ...
            <div class="col-md-8">
						<?php
							...
							$query1 = "Select * From post,user,category
												...
												AND (post.title LIKE '%{$search}%' OR post.description LIKE '%{$search}%');";
							$result = mysqli_query($conn,$query1) or die("Query Unsuccessful");
							$noOfRecords = mysqli_num_rows($result);
							if($noOfRecords == 0) die('<h1>Nothing Matched your Search.</h1>');
						?>
						<h2 class="page-heading"><?php echo "Search Results: ".$search ?></h2>
                <!-- post-container -->
                <div class="post-container">
                    ...
                    <div class="post-content">
                        <div class="row">
                            <div class="col-md-4">
                                <a class="post-img" href="single.php"><img src="uploads/<?php echo $imgName;?>" alt=""/></a>
                            </div>
                            <div class="col-md-8">
