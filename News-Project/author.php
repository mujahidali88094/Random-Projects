        ...
        <div class="row">
            <div class="col-md-8">
						<?php
							...
							//to get author name
							$query1 = "Select * From user WHERE user_id={$authorID};";
							$result = mysqli_query($conn,$query1) or die("Query Unsuccessful");
							$row = mysqli_fetch_assoc($result);
							$author = $row['first_name']." ".$row['last_name'];
						?>
						<h2 class="page-heading"><?php echo "Author: ".$author; ?></h2>
                <!-- post-container -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="inner-content clearfix">
                                    <h3><a class="discardAnchor" href="single.php?id=<?php echo $id; ?>"><?php echo $title;?></a></a></h3>
                                    ...
                                    <a class='read-more pull-right' href='single.php?id=<?php echo $id; ?>'>read more</a>
										...
										<?php
											...
											for($i=1;$i<=$noOfPages;$i++){
												...
												echo "<li {$isActive}><a href='category.php?author={$authorID}&page={$i}'>{$i}</a></li>";
											}
											?>
                    </ul>
                </div><!-- /post-container -->
